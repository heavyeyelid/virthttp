...
[[nodiscard]] inline Domain Domain::createXML(Connection& c, gsl::czstring<> xml, enums::domain::CreateFlag flags) {
...
inline bool Domain::addIOThread(unsigned int iothread_id, enums::domain::ModificationImpactFlag flags) noexcept {
...
inline bool Domain::attachDevice(gsl::czstring<> xml, enums::domain::DeviceModifyFlag flags) noexcept {
...
inline bool Domain::blockCopy(gsl::czstring<> disk, gsl::czstring<> destxml, const TypedParams& params, enums::domain::BlockCopyFlag flags) noexcept {
    return virDomainBlockCopy(underlying, disk, destxml, params.underlying, params.size, to_integral(flags)) >= 0;
}

inline bool Domain::blockJobAbort(gsl::czstring<> disk, enums::domain::BlockJobAbortFlag flags) noexcept {
    return virDomainBlockJobAbort(underlying, disk, to_integral(flags)) >= 0;
}

inline bool Domain::blockJobSetSpeed(gsl::czstring<> disk, unsigned long bandwidth, enums::domain::BlockJobSetSpeedFlag flags) noexcept {
...
inline bool Domain::blockPull(gsl::czstring<> disk, unsigned long bandwidth, enums::domain::BlockPullFlag flags) noexcept {
    return virDomainBlockPull(underlying, disk, bandwidth, to_integral(flags)) >= 0;
}

inline bool Domain::blockRebase(gsl::czstring<> disk, gsl::czstring<> base, unsigned long bandwidth, enums::domain::BlockRebaseFlag flags) {
    return virDomainBlockRebase(underlying, disk, base, bandwidth, to_integral(flags)) >= 0;
}

inline bool Domain::blockResize(gsl::czstring<> disk, unsigned long long size, enums::domain::BlockResizeFlag flags) noexcept {
...
inline auto Domain::blockStatsFlags(gsl::czstring<> disk, enums::TypedParameterFlag flags) const noexcept {
...
inline bool Domain::create(enums::domain::CreateFlag flags) noexcept { return virDomainCreateWithFlags(underlying, to_integral(flags)) == 0; }
...
inline bool Domain::delIOThread(unsigned int iothread_id, enums::domain::ModificationImpactFlag flags) noexcept {
...
inline bool Domain::destroy(enums::domain::DestroyFlag flags) noexcept { return virDomainDestroyFlags(underlying, to_integral(flags)) == 0; }

inline bool Domain::detachDevice(gsl::czstring<> xml) noexcept { return virDomainDetachDevice(underlying, xml) == 0; }

inline bool Domain::detachDevice(gsl::czstring<> xml, enums::domain::DeviceModifyFlag flags) noexcept {
    return virDomainDetachDeviceFlags(underlying, xml, to_integral(flags)) == 0;
}

inline bool Domain::detachDeviceAlias(gsl::czstring<> alias, enums::domain::DeviceModifyFlag flags) noexcept {
...
[[nodiscard]] inline auto Domain::getBlkioParameters(enums::domain::MITPFlags flags) const noexcept {
...
[[nodiscard]] inline auto Domain::getBlockIoTune(gsl::czstring<> disk, enums::domain::MITPFlags flags) const noexcept {
    return TPImpl::wrap_oparm_fill_tp(
        underlying, [=](auto* u, auto ptr, auto* n, auto f) { return virDomainGetBlockIoTune(u, disk, ptr, n, f); }, to_integral(flags));
}

[[nodiscard]] inline auto Domain::getBlockJobInfo(gsl::czstring<> disk, enums::domain::BlockJobInfoFlag flags) const noexcept {
...
[[nodiscard]] inline auto Domain::getJobStats(enums::domain::GetJobStatsFlag flags) const noexcept {
...
[[nodiscard]] inline auto Domain::getIOThreadInfo(enums::domain::ModificationImpactFlag flags) const noexcept {
...
[[nodiscard]] inline auto Domain::extractIOThreadInfo(enums::domain::ModificationImpactFlag flags) const -> std::vector<heavy::IOThreadInfo> {
...
[[nodiscard]] inline auto Domain::getInterfaceParameters(gsl::czstring<> device, enums::domain::MITPFlags flags) const noexcept {
    return TPImpl::wrap_oparm_fill_tp(
...
[[nodiscard]] inline auto Domain::getMemoryParameters(enums::domain::MITPFlags flags) const noexcept {
    return TPImpl::wrap_oparm_fill_tp(underlying, virDomainGetMemoryParameters, to_integral(flags));
}

[[nodiscard]] inline UniqueZstring Domain::getMetadata(enums::domain::MetadataType type, gsl::czstring<> ns,
...
[[nodiscard]] inline std::string Domain::extractMetadata(enums::domain::MetadataType type, gsl::czstring<> ns,
...
[[nodiscard]] inline auto Domain::getNumaParameters(enums::domain::MITPFlags flags) const noexcept {
...
[[nodiscard]] inline auto Domain::getPerfEvents(enums::domain::MITPFlags flags) const noexcept {
...
[[nodiscard]] inline auto Domain::getSchedulerParameters(enums::domain::MITPFlags flags) const noexcept {
    const auto sche_type = getSchedulerType();
    if (!sche_type.first)
        return std::optional<TypedParams>{std::nullopt};
    return TPImpl::wrap_oparm_fill_tp(
...
inline bool Domain::managedSave(enums::domain::SaveRestoreFlag flags) noexcept { return virDomainManagedSave(underlying, to_integral(flags)) == 0; }

inline bool Domain::managedSaveDefineXML(gsl::czstring<> dxml, enums::domain::SaveRestoreFlag flags) noexcept {
...
[[nodiscard]] inline Domain Domain::migrate(Connection dconn, enums::domain::MigrateFlag flags, gsl::czstring<> dname, gsl::czstring<> uri,
...
[[nodiscard]] inline Domain Domain::migrate(Connection dconn, gsl::czstring<> dxml, enums::domain::MigrateFlag flags, gsl::czstring<> dname,
                                            gsl::czstring<> uri, unsigned long bandwidth) noexcept {
    return Domain{virDomainMigrate2(underlying, dconn.underlying, dxml, to_integral(flags), dname, uri, bandwidth)};
}

[[nodiscard]] inline Domain Domain::migrate(Connection dconn, const TypedParams& params, enums::domain::MigrateFlag flags) noexcept {
    return Domain{virDomainMigrate3(underlying, dconn.underlying, params.underlying, params.size, to_integral(flags))};
}

inline bool Domain::migrateToURI(gsl::czstring<> duri, enums::domain::MigrateFlag flags, gsl::czstring<> dname, unsigned long bandwidth) noexcept {
    return virDomainMigrateToURI(underlying, duri, to_integral(flags), dname, bandwidth) >= 0;
}

inline bool Domain::migrateToURI(gsl::czstring<> dconnuri, gsl::czstring<> miguri, gsl::czstring<> dxml, enums::domain::MigrateFlag flags,
                                 gsl::czstring<> dname, unsigned long bandwidth) noexcept {
    return virDomainMigrateToURI2(underlying, dconnuri, miguri, dxml, to_integral(flags), dname, bandwidth) >= 0;
}

inline bool Domain::migrateToURI(gsl::czstring<> dconnuri, const TypedParams& params, enums::domain::MigrateFlag flags) noexcept {
...
inline bool Domain::openChannel(gsl::czstring<> name, Stream& st, enums::domain::ChannelFlag flags) noexcept {
    return virDomainOpenChannel(underlying, name, st.underlying, to_integral(flags)) >= 0;
}

inline bool Domain::openConsole(gsl::czstring<> dev_name, Stream& st, enums::domain::ConsoleFlag flags) noexcept {
    return virDomainOpenConsole(underlying, dev_name, st.underlying, to_integral(flags)) >= 0;
}

inline bool Domain::openGraphics(unsigned int idx, int fd, enums::domain::OpenGraphicsFlag flags) const noexcept {
    return virDomainOpenGraphics(underlying, idx, fd, to_integral(flags)) >= 0;
}

[[nodiscard]] inline int Domain::openGraphicsFD(unsigned int idx, enums::domain::OpenGraphicsFlag flags) const noexcept {
    return virDomainOpenGraphicsFD(underlying, idx, to_integral(flags));
}

inline bool Domain::pinEmulator(CpuMap cpumap, enums::domain::ModificationImpactFlag flags) noexcept {
    return virDomainPinEmulator(underlying, cpumap.underlying, cpumap.maplen, to_integral(flags)) >= 0;
}

inline bool Domain::pinIOThread(unsigned int iothread_id, CpuMap cpumap, enums::domain::ModificationImpactFlag flags) noexcept {
...
inline bool Domain::pinVcpuFlags(unsigned int vcpu, CpuMap cpumap, enums::domain::ModificationImpactFlag flags) noexcept {
    return virDomainPinVcpuFlags(underlying, vcpu, cpumap.underlying, cpumap.maplen, to_integral(flags)) >= 0;
}

inline bool Domain::sendKey(enums::domain::KeycodeSet codeset, unsigned int holdtime, gsl::span<const unsigned int> keycodes) noexcept {
    return virDomainSendKey(underlying, to_integral(codeset), holdtime, const_cast<unsigned int*>(keycodes.data()), keycodes.size(), 0) >= 0;
}

inline bool Domain::sendProcessSignal(long long pid_value, enums::domain::ProcessSignal signum) noexcept {
...
inline bool Domain::setMemoryStatsPeriod(int period, enums::domain::MemoryModFlag flags) noexcept {
...
inline bool Domain::reboot(enums::domain::ShutdownFlag flags) { return virDomainReboot(underlying, to_integral(flags)) == 0; }
...
inline bool Domain::save(gsl::czstring<> to, gsl::czstring<> dxml, enums::domain::SaveRestoreFlag flags) noexcept {
...
inline bool Domain::setBlkioParameters(TypedParams params, enums::domain::ModificationImpactFlag flags) noexcept {
    return virDomainSetBlkioParameters(underlying, params.underlying, params.size, to_integral(flags)) >= 0;
}

inline bool Domain::setBlockIoTune(gsl::czstring<> disk, TypedParams params, enums::domain::ModificationImpactFlag flags) noexcept {
...
inline bool Domain::setIOThreadParams(unsigned int iothread_id, TypedParams params, enums::domain::MITPFlags flags) noexcept {
    return virDomainSetIOThreadParams(underlying, iothread_id, params.underlying, params.size, to_integral(flags)) >= 0;
}

inline bool Domain::setInterfaceParameters(gsl::czstring<> device, TypedParams params, enums::domain::ModificationImpactFlag flags) noexcept {
    return virDomainSetInterfaceParameters(underlying, device, params.underlying, params.size, to_integral(flags)) >= 0;
}
inline bool Domain::setLifecycleAction(enums::domain::Lifecycle type, enums::domain::LifecycleAction action,
...
inline bool Domain::setMemoryFlags(unsigned long memory, enums::domain::MemoryModFlag flags) noexcept {
    return virDomainSetMemoryFlags(underlying, memory, to_integral(flags)) >= 0;
}

inline bool Domain::setMemoryParameters(TypedParams params, enums::domain::ModificationImpactFlag flags) noexcept {
    return virDomainSetMemoryParameters(underlying, params.underlying, params.size, to_integral(flags)) >= 0;
}

inline bool Domain::setNumaParameters(TypedParams params, enums::domain::ModificationImpactFlag flags) noexcept {
    return virDomainSetNumaParameters(underlying, params.underlying, params.size, to_integral(flags)) >= 0;
}

inline bool Domain::setPerfEvents(TypedParams params, enums::domain::ModificationImpactFlag flags) noexcept {
...
inline bool Domain::setSchedulerParameters(TypedParams params, enums::domain::ModificationImpactFlag flags) noexcept {
    return virDomainSetSchedulerParametersFlags(underlying, params.underlying, params.size, to_integral(flags)) >= 0;
}

inline bool Domain::setMetadata(enums::domain::MetadataType type, gsl::czstring<> metadata, gsl::czstring<> key, gsl::czstring<> uri,
                                enums::domain::ModificationImpactFlag flags) noexcept {
...
inline bool Domain::setVcpu(gsl::czstring<> vcpumap, bool state, enums::domain::ModificationImpactFlag flags) noexcept {
...
inline bool Domain::shutdown(enums::domain::ShutdownFlag flags) noexcept { return virDomainShutdownFlags(underlying, to_integral(flags)) == 0; }
...
inline bool Domain::undefine(enums::domain::UndefineFlag flags) noexcept { return virDomainUndefineFlags(underlying, to_integral(flags)) == 0; }

inline bool Domain::updateDeviceFlags(gsl::czstring<> xml, enums::domain::DeviceModifyFlag flags) noexcept {
